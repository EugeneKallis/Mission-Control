      ...
      <div className="relative">
        ...
        {toolsOpen && (
          <>
            ...
            />
            <div className="absolute top-full right-0 mt-1 z-50 bg-surface border border-outline-variant/30 shadow-xl min-w-[220px] max-h-[min(70vh,400px)] overflow-y-auto">
        ...
        <div className="relative">
          ...
          {skillsOpen && (
            <>
              ...
              />
              <div className="absolute top-full right-0 mt-1 z-50 bg-surface border border-outline-variant/30 shadow-xl min-w-[240px] max-h-[min(70vh,400px)] overflow-y-auto">
                <div className="px-3 py-2 text-[10px] font-semibold uppercase tracking-widest text-on-surface-variant/50 border-b border-outline-variant/20">
