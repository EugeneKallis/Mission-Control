...
function GroupCard({ group, index, count, onToggleDefaultCollapsed, onRename, onDelete, onMove, onToggleHidden }: { group: NavGroup; index: number; count: number; onToggleDefaultCollapsed: () => void; onRename: (name: string) => void; onDelete: () => void; onMove: (direction: -1 | 1) => void; onToggleHidden: (key: string) => void }) {
