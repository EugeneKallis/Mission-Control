...
import { NAV_BY_KEY, NAV_COLOR_CLASSES, NAV_COLORS, NAV_ICONS, defaultSidebarLayout, type NavCustomization, type NavGroup, type SidebarLayout } from "@/lib/nav-registry";
